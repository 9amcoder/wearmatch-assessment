export interface Listing {
  ...
  price_per_outbound_pallet: string;
  labeling_price: string;
  palletization_price: string;
  kitting_assembly_price: string;
  ...
  destuffing_non_palletized_container_cost_20ft: string;
  destuffing_non_palletized_container_cost_40ft: string;
  destuffing_non_palletized_container_cost_53ft: string;
  listing_type: string;
